...
namespace Utilities.xButton
{
	[Browsable(false)]
	[DebuggerStepThrough]
	[EditorBrowsable(EditorBrowsableState.Never)]
	internal class ButtonStatesColorEditor : UITypeEditor
	{
		...
		{
            xCollection.xButton.StateProperties stateProperties = ((e.Context != null) ? ((xCollection.xButton.StateProperties)e.Value) : new xCollection.xButton.StateProperties());
