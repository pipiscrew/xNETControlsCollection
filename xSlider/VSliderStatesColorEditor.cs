...
namespace Utilities.xSlider
{
	...
	[Browsable(false)]
	internal class VSliderStatesColorEditor : UITypeEditor
	{
		...
		{
			xVSlider.SliderState sliderState = ((e.Context != null) ? ((xVSlider.SliderState)e.Value) : new xVSlider.SliderState("Painter"));
